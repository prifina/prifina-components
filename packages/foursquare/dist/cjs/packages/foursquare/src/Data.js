...
var index = require('../../../node_modules/@dynamic-data/foursquare-data/dist/esm/mockups/index.js');
...
var getFields = function getFields(query) {
  ...
  switch (query) {
    case "queryPhotosDetails":
      fields = Object.keys(index.Photos.photos_details);
      break;

    case "queryTipsDetails":
      fields = Object.keys(index.Tips.tips_details);
      break;

    case "queryVenuesCategories":
      fields = Object.keys(index.Venues.venues_categories);
      break;

    case "queryVenuesDetails":
      fields = Object.keys(index.Venues.venues_details);
      break;

    case "queryVenuesGetRecommendations":
      fields = Object.keys(index.Venues.venues_getRecommendations);
      break;

    case "queryVenuesGetVenueList":
      fields = Object.keys(index.Venues.venues_getVenueList);
      break;

    case "queryVenuesHours":
      fields = Object.keys(index.Venues.venues_hours);
      break;

    case "queryVenuesLikes":
      fields = Object.keys(index.Venues.venues_likes);
      break;

    case "queryVenuesNextVenues":
      fields = Object.keys(index.Venues.venues_nextVenues);
      break;

    case "queryVenuesPhotos":
      fields = Object.keys(index.Venues.venues_photos);
      break;

    case "queryVenuesSearch":
      fields = Object.keys(index.Venues.venues_search);
      break;

    case "queryVenuesSimilarVenues":
      fields = Object.keys(index.Venues.venues_similarVenues);
      break;

    case "queryVenuesSuggestSearch":
      fields = Object.keys(index.Venues.venues_suggestSearch);
      break;

    case "queryVenuesTips":
      fields = Object.keys(index.Venues.venues_tips);
      break;

    case "queryVenuesTrending":
      fields = Object.keys(index.Venues.venues_trending);
      break;
...
var queryPhotosDetails = function queryPhotosDetails(_ref) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Photos.photos_details
        }
      }
    });
  } else {
...
var queryTipsDetails = function queryTipsDetails(_ref2) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Tips.tips_details
        }
      }
    });
  } else {
...
var queryVenuesCategories = function queryVenuesCategories(_ref3) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Venues.venues_categories
        }
      }
    });
  } else {
...
var queryVenuesDetails = function queryVenuesDetails(_ref4) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Venues.venues_details
        }
      }
    });
  } else {
...
var queryVenuesGetRecommendations = function queryVenuesGetRecommendations(_ref5) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Venues.venues_getRecommendations
        }
      }
    });
  } else {
...
var queryVenuesGetVenueList = function queryVenuesGetVenueList(_ref6) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Venues.venues_getVenueList
        }
      }
    });
  } else {
...
var queryVenuesHours = function queryVenuesHours(_ref7) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Venues.venues_hours
        }
      }
    });
  } else {
...
var queryVenuesLikes = function queryVenuesLikes(_ref8) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Venues.venues_likes
        }
      }
    });
  } else {
...
var queryVenuesNextVenues = function queryVenuesNextVenues(_ref9) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Venues.venues_nextVenues
        }
      }
    });
  } else {
...
var queryVenuesPhotos = function queryVenuesPhotos(_ref10) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Venues.venues_photos
        }
      }
    });
  } else {
...
var queryVenuesSearch = function queryVenuesSearch(_ref11) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Venues.venues_search
        }
      }
    });
  } else {
...
var queryVenuesSimilarVenues = function queryVenuesSimilarVenues(_ref12) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Venues.venues_similarVenues
        }
      }
    });
  } else {
...
var queryVenuesSuggestSearch = function queryVenuesSuggestSearch(_ref13) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Venues.venues_suggestSearch
        }
      }
    });
  } else {
...
var queryVenuesTips = function queryVenuesTips(_ref14) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Venues.venues_tips
        }
      }
    });
  } else {
...
var queryVenuesTrending = function queryVenuesTrending(_ref15) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: index.Venues.venues_trending
        }
      }
    });
  } else {
...
exports.queryPhotosDetails = queryPhotosDetails;
exports.queryTipsDetails = queryTipsDetails;
exports.queryVenuesCategories = queryVenuesCategories;
exports.queryVenuesDetails = queryVenuesDetails;
exports.queryVenuesGetRecommendations = queryVenuesGetRecommendations;
exports.queryVenuesGetVenueList = queryVenuesGetVenueList;
exports.queryVenuesHours = queryVenuesHours;
exports.queryVenuesLikes = queryVenuesLikes;
exports.queryVenuesNextVenues = queryVenuesNextVenues;
exports.queryVenuesPhotos = queryVenuesPhotos;
exports.queryVenuesSearch = queryVenuesSearch;
exports.queryVenuesSimilarVenues = queryVenuesSimilarVenues;
exports.queryVenuesSuggestSearch = queryVenuesSuggestSearch;
exports.queryVenuesTips = queryVenuesTips;
exports.queryVenuesTrending = queryVenuesTrending;
