...
var Acc = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/Acc.js');
var Ble = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/Ble.js');
var Debug = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/Debug.js');
var ECG = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/ECG.js');
var Gyro = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/Gyro.js');
var HR = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/HR.js');
var IMU = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/IMU.js');
var Info = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/Info.js');
var LED = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/LED.js');
var Magn = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/Magn.js');
var Manufacuring = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/Manufacuring.js');
var Memory = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/Memory.js');
var Mode = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/Mode.js');
var State = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/State.js');
var Temp = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/Temp.js');
var eeprom = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/eeprom.js');
var ind = require('../../../node_modules/@dynamic-data/movesense-data/dist/esm/mockups/ind.js');
...
var getFields = function getFields(query) {
  ...
  switch (query) {
    case "queryAccConfig":
      fields = Object.keys(Acc.AccConfig);
      break;

    case "queryAccData":
      fields = Object.keys(Acc.AccData);
      break;

    case "queryAccInfo":
      fields = Object.keys(Acc.AccInfo);
      break;

    case "queryAdvSettings":
      fields = Object.keys(Ble.AdvSettings);
      break;

    case "queryAdvState":
      fields = Object.keys(Ble.AdvState);
      break;

    case "queryAppInfo":
      fields = Object.keys(Info.AppInfo);
      break;

    case "queryBleConfig":
      fields = Object.keys(Ble.BleConfig);
      break;

    case "queryBondList":
      fields = Object.keys(Ble.BondList);
      break;

    case "queryBondingSettings":
      fields = Object.keys(Ble.BondingSettings);
      break;

    case "queryCalibrationData":
      fields = Object.keys(Manufacuring.CalibrationData);
      break;

    case "queryCalibrationMatrix":
      fields = Object.keys(Manufacuring.CalibrationMatrix);
      break;

    case "queryDebugLogConfig":
      fields = Object.keys(Debug.DebugLogConfig);
      break;

    case "queryDebugLogResult":
      fields = Object.keys(Debug.DebugLogResult);
      break;

    case "queryDebugMessage":
      fields = Object.keys(Debug.DebugMessage);
      break;

    case "queryDebugMessageConfig":
      fields = Object.keys(Debug.DebugMessageConfig);
      break;

    case "queryDeviceInfo":
      fields = Object.keys(Info.DeviceInfo);
      break;

    case "queryECGConfig":
      fields = Object.keys(ECG.ECGConfig);
      break;

    case "queryECGData":
      fields = Object.keys(ECG.ECGData);
      break;

    case "queryECGInfo":
      fields = Object.keys(ECG.ECGInfo);
      break;

    case "queryEepromData":
      fields = Object.keys(eeprom.EepromData);
      break;

    case "queryEepromInfo":
      fields = Object.keys(eeprom.EepromInfo);
      break;

    case "queryFaultInfo":
      fields = Object.keys(Debug.FaultInfo);
      break;

    case "queryGyroConfig":
      fields = Object.keys(Gyro.GyroConfig);
      break;

    case "queryGyroData":
      fields = Object.keys(Gyro.GyroData);
      break;

    case "queryGyroInfo":
      fields = Object.keys(Gyro.GyroInfo);
      break;

    case "queryHRData":
      fields = Object.keys(HR.HRData);
      break;

    case "queryHRInfo":
      fields = Object.keys(HR.HRInfo);
      break;

    case "queryIMU6Data":
      fields = Object.keys(IMU.IMU6Data);
      break;

    case "queryIMU6MData":
      fields = Object.keys(IMU.IMU6MData);
      break;

    case "queryIMU9Data":
      fields = Object.keys(IMU.IMU9Data);
      break;

    case "queryIMUConfig":
      fields = Object.keys(IMU.IMUConfig);
      break;

    case "queryIMUInfo":
      fields = Object.keys(IMU.IMUInfo);
      break;

    case "queryLedState":
      fields = Object.keys(LED.LedState);
      break;

    case "queryLeds":
      fields = Object.keys(LED.Leds);
      break;

    case "queryMagnConfig":
      fields = Object.keys(Magn.MagnConfig);
      break;

    case "queryMagnData":
      fields = Object.keys(Magn.MagnData);
      break;

    case "queryMagnInfo":
      fields = Object.keys(Magn.MagnInfo);
      break;

    case "queryMemory":
      fields = Object.keys(Memory.Memory);
      break;

    case "queryModuleStatus":
      fields = Object.keys(Info.ModuleStatus);
      break;

    case "queryPeerChange":
      fields = Object.keys(Ble.PeerChange);
      break;

    case "queryPeerList":
      fields = Object.keys(Ble.PeerList);
      break;

    case "queryProductData":
      fields = Object.keys(Manufacuring.ProductData);
      break;

    case "queryResetReason":
      fields = Object.keys(Debug.ResetReason);
      break;

    case "queryScanResult":
      fields = Object.keys(Ble.ScanResult);
      break;

    case "queryState":
      fields = Object.keys(State.State);
      break;

    case "queryStateChange":
      fields = Object.keys(State.StateChange);
      break;

    case "queryStepsDone":
      fields = Object.keys(Manufacuring.StepsDone);
      break;

    case "querySystemModeStatus":
      fields = Object.keys(Mode.SystemModeStatus);
      break;

    case "queryTempInfo":
      fields = Object.keys(Temp.TempInfo);
      break;

    case "queryTemperatureValue":
      fields = Object.keys(Temp.TemperatureValue);
      break;

    case "queryVisualIndState":
      fields = Object.keys(ind.VisualIndState);
      break;
...
var queryCalibrationData = function queryCalibrationData(_ref10) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: Manufacuring.CalibrationData
        }
      }
    });
  } else {
...
var queryCalibrationMatrix = function queryCalibrationMatrix(_ref11) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: Manufacuring.CalibrationMatrix
        }
      }
    });
  } else {
...
var queryDebugMessageConfig = function queryDebugMessageConfig(_ref15) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: Debug.DebugMessageConfig
        }
      }
    });
  } else {
...
var queryProductData = function queryProductData(_ref42) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: Manufacuring.ProductData
        }
      }
    });
  } else {
...
var queryStepsDone = function queryStepsDone(_ref47) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: Manufacuring.StepsDone
        }
      }
    });
  } else {
...
exports.queryAccConfig = queryAccConfig;
exports.queryAccData = queryAccData;
exports.queryAccInfo = queryAccInfo;
exports.queryAdvSettings = queryAdvSettings;
exports.queryAdvState = queryAdvState;
exports.queryAppInfo = queryAppInfo;
exports.queryBleConfig = queryBleConfig;
exports.queryBondList = queryBondList;
exports.queryBondingSettings = queryBondingSettings;
exports.queryCalibrationData = queryCalibrationData;
exports.queryCalibrationMatrix = queryCalibrationMatrix;
exports.queryDebugLogConfig = queryDebugLogConfig;
exports.queryDebugLogResult = queryDebugLogResult;
exports.queryDebugMessage = queryDebugMessage;
exports.queryDebugMessageConfig = queryDebugMessageConfig;
exports.queryDeviceInfo = queryDeviceInfo;
exports.queryECGConfig = queryECGConfig;
exports.queryECGData = queryECGData;
exports.queryECGInfo = queryECGInfo;
exports.queryEepromData = queryEepromData;
exports.queryEepromInfo = queryEepromInfo;
exports.queryFaultInfo = queryFaultInfo;
exports.queryGyroConfig = queryGyroConfig;
exports.queryGyroData = queryGyroData;
exports.queryGyroInfo = queryGyroInfo;
exports.queryHRData = queryHRData;
exports.queryHRInfo = queryHRInfo;
exports.queryIMU6Data = queryIMU6Data;
exports.queryIMU6MData = queryIMU6MData;
exports.queryIMU9Data = queryIMU9Data;
exports.queryIMUConfig = queryIMUConfig;
exports.queryIMUInfo = queryIMUInfo;
exports.queryLedState = queryLedState;
exports.queryLeds = queryLeds;
exports.queryMagnConfig = queryMagnConfig;
exports.queryMagnData = queryMagnData;
exports.queryMagnInfo = queryMagnInfo;
exports.queryMemory = queryMemory;
exports.queryModuleStatus = queryModuleStatus;
exports.queryPeerChange = queryPeerChange;
exports.queryPeerList = queryPeerList;
exports.queryProductData = queryProductData;
exports.queryResetReason = queryResetReason;
exports.queryScanResult = queryScanResult;
exports.queryState = queryState;
exports.queryStateChange = queryStateChange;
exports.queryStepsDone = queryStepsDone;
exports.querySystemModeStatus = querySystemModeStatus;
exports.queryTempInfo = queryTempInfo;
exports.queryTemperatureValue = queryTemperatureValue;
exports.queryVisualIndState = queryVisualIndState;
