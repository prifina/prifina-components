...
var cardioActivity = require('../../../node_modules/@dynamic-data/runkeeper-data/dist/esm/mockups/cardioActivity.js');
...
var getFields = function getFields(query) {
  ...
  switch (query) {
    case "queryCardioActivity":
      fields = Object.keys(cardioActivity.cardioActivity);
      break;
...
var queryCardioActivity = function queryCardioActivity(_ref) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: cardioActivity.cardioActivity
        }
      }
    });
  } else {
...
exports.queryCardioActivity = queryCardioActivity;
