...
import {
  ...
  HKWorkoutRoute,
  HKWorkoutSession,
} from "@dynamic-data/ios-health-data/mockups";
...
export const queryCharacteristics = ({
  stage,
  appID,
  name,
  createQuery,
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: { content: Characteristics },
      },
    });
  } else {
...
export const queryHKActivitySummary = ({
  stage,
  appID,
  name,
  createQuery,
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: { content: HKActivitySummary },
      },
    });
  } else {
    //SELECT * FROM s3object s  where EXTRACT(YEAR FROM TO_TIMESTAMP(s.p_datetime))=2021 LIMIT 5
...
export const queryHKAudiogramSample = ({
  stage,
  appID,
  name,
  createQuery,
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: { content: HKAudiogramSample },
      },
    });
  } else {
    //SELECT * FROM s3object s  where EXTRACT(YEAR FROM TO_TIMESTAMP(s.p_datetime))=2021 LIMIT 5
...
export const queryHKClinicalRecord = ({
  stage,
  appID,
  name,
  createQuery,
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: { content: HKClinicalRecord },
      },
    });
  } else {
    //SELECT * FROM s3object s  where EXTRACT(YEAR FROM TO_TIMESTAMP(s.p_datetime))=2021 LIMIT 5
...
export const queryHKElectrocardiogram = ({
  stage,
  appID,
  name,
  createQuery,
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: { content: HKElectrocardiogram },
      },
    });
  } else {
    //SELECT * FROM s3object s  where EXTRACT(YEAR FROM TO_TIMESTAMP(s.p_datetime))=2021 LIMIT 5
...
export const queryHKWorkout = ({
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: { content: HKWorkout },
      },
    });
  } else {
    //SELECT * FROM s3object s  where EXTRACT(YEAR FROM TO_TIMESTAMP(s.p_datetime))=2021 LIMIT 5
...
export const queryHKWorkoutConfiguration = ({
  stage,
  appID,
  name,
  createQuery,
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: { content: HKWorkoutConfiguration },
      },
    });
  } else {
    //SELECT * FROM s3object s  where EXTRACT(YEAR FROM TO_TIMESTAMP(s.p_datetime))=2021 LIMIT 5
...
export const queryHKWorkoutRoute = ({
  stage,
  appID,
  name,
  createQuery,
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: { content: HKWorkoutRoute },
      },
    });
  } else {
    //SELECT * FROM s3object s  where EXTRACT(YEAR FROM TO_TIMESTAMP(s.p_datetime))=2021 LIMIT 5
...
export const queryHKWorkoutSession = ({
  stage,
  appID,
  name,
  createQuery,
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: { content: HKWorkoutSession },
      },
    });
  } else {
    //SELECT * FROM s3object s  where EXTRACT(YEAR FROM TO_TIMESTAMP(s.p_datetime))=2021 LIMIT 5
