...
function _fn(fnName, fnCol, fnOpts) {
  ...
  if (fnName === "SUBSTRING") {
    if (_rollupPluginBabelHelpers["typeof"](fnOpts) !== "object" || fnOpts.length === 0) {
  ...
  if (fnName === "DATE_ADD") {
    if (_rollupPluginBabelHelpers["typeof"](fnOpts) !== "object" || fnOpts.length != 2) {
...
function buildProviderFilter() {
  ...
  var s = {};
  var logicalOperators = Object.getOwnPropertySymbols(filter); //console.log("LOG ", logicalOperators);

  if (logicalOperators.length > 0) {
    logicalOperators.forEach(function (logicalOP) {
      var logicalOPSymbol = Symbol.keyFor(logicalOP).trim();
      s[logicalOPSymbol] = {};
      Object.keys(filter[logicalOP]).forEach(function (k, ii) {
        //console.log("KEY ", k);
        s[logicalOPSymbol][[k]] = {};
        Object.getOwnPropertySymbols(filter[logicalOP][k]).forEach(function (e, i) {
          //console.log("E ", e);
          s[logicalOPSymbol][[k]][[Symbol.keyFor(e).trim()]] = filter[logicalOP][k][e];
          console.log("II ", ii);
        });
      });
    });
    ...
    if (Object.keys(filter).length > 0) {
      Object.keys(filter).forEach(function (k, ii) {
        s[[k]] = {};
        Object.getOwnPropertySymbols(filter[k]).forEach(function (e, i) {
          //console.log("E ", e);
          s[k][[Symbol.keyFor(e).trim()]] = filter[k][e];
          console.log("ONE COND ", i);
        });
      });
    }
  }
...
exports.buildProviderFilter = buildProviderFilter;
