...
var Activity = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/Activity.js');
var ActivityComments = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/ActivityComments.js');
var ActivityKudoers = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/ActivityKudoers.js');
var ActivityLaps = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/ActivityLaps.js');
var ActivityStream = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/ActivityStream.js');
var ActivityZones = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/ActivityZones.js');
var AthleteActivities = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/AthleteActivities.js');
var AthleteClubs = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/AthleteClubs.js');
var AthleteRoute = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/AthleteRoute.js');
var AthleteStats = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/AthleteStats.js');
var AuthenticatedAthlete = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/AuthenticatedAthlete.js');
var Club = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/Club.js');
var ClubActivities = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/ClubActivities.js');
var ClubAdministrators = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/ClubAdministrators.js');
var ClubMembers = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/ClubMembers.js');
var Equipment = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/Equipment.js');
var Route = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/Route.js');
var RouteStream = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/RouteStream.js');
var SegmentEfforts = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/SegmentEfforts.js');
var SegmentEffortsStream = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/SegmentEffortsStream.js');
var Segments = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/Segments.js');
var SegmentsStreams = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/SegmentsStreams.js');
var StarredSegments = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/StarredSegments.js');
var Upload = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/Upload.js');
var Zones = require('../../../node_modules/@dynamic-data/strava-data/dist/esm/mockups/Zones.js');
...
var getFields = function getFields(query) {
  ...
  switch (query) {
    case "queryActivity":
      fields = Object.keys(Activity.Activity);
      break;

    case "queryActivityComments":
      fields = Object.keys(ActivityComments.ActivityComments);
      break;

    case "queryActivityKudoers":
      fields = Object.keys(ActivityKudoers.ActivityKudoers);
      break;

    case "queryActivityLaps":
      fields = Object.keys(ActivityLaps.ActivityLaps);
      break;

    case "queryActivityStream":
      fields = Object.keys(ActivityStream.ActivityStream);
      break;

    case "queryActivityZone":
      fields = Object.keys(ActivityZones.ActivityZone);
      break;

    case "queryAthleteActivities":
      fields = Object.keys(AthleteActivities.AthleteActivities);
      break;

    case "queryAthleteClubs":
      fields = Object.keys(AthleteClubs.AthleteClubs);
      break;

    case "queryAthleteRoute":
      fields = Object.keys(AthleteRoute.AthleteRoute);
      break;

    case "queryAthleteStats":
      fields = Object.keys(AthleteStats.AthleteStats);
      break;

    case "queryAuthenticatedAthlete":
      fields = Object.keys(AuthenticatedAthlete.AuthenticatedAthlete);
      break;

    case "queryClub":
      fields = Object.keys(Club.Club);
      break;

    case "queryClubActivities":
      fields = Object.keys(ClubActivities.ClubActivities);
      break;

    case "queryClubAdministrators":
      fields = Object.keys(ClubAdministrators.ClubAdministrators);
      break;

    case "queryClubMembers":
      fields = Object.keys(ClubMembers.ClubMembers);
      break;

    case "queryEquipment":
      fields = Object.keys(Equipment.Equipment);
      break;

    case "queryRoute":
      fields = Object.keys(Route.Route);
      break;

    case "queryRouteStream":
      fields = Object.keys(RouteStream.RouteStream);
      break;

    case "querySegmentEfforts":
      fields = Object.keys(SegmentEfforts.SegmentEfforts);
      break;

    case "querySegmentEffortsStream":
      fields = Object.keys(SegmentEffortsStream.SegmentEffortsStream);
      break;

    case "querySegments":
      fields = Object.keys(Segments.Segments);
      break;

    case "querySegmentsStreams":
      fields = Object.keys(SegmentsStreams.SegmentsStreams);
      break;

    case "queryStarredSegments":
      fields = Object.keys(StarredSegments.StarredSegments);
      break;

    case "queryUpload":
      fields = Object.keys(Upload.Upload);
      break;

    case "queryZones":
      fields = Object.keys(Zones.Zones);
      break;
...
var queryActivityComments = function queryActivityComments(_ref2) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: ActivityComments.ActivityComments
        }
      }
    });
  } else {
...
var queryActivityKudoers = function queryActivityKudoers(_ref3) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: ActivityKudoers.ActivityKudoers
        }
      }
    });
  } else {
...
var queryActivityLaps = function queryActivityLaps(_ref4) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: ActivityLaps.ActivityLaps
        }
      }
    });
  } else {
...
var queryActivityStream = function queryActivityStream(_ref5) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: ActivityStream.ActivityStream
        }
      }
    });
  } else {
...
var queryActivityZone = function queryActivityZone(_ref6) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: ActivityZones.ActivityZone
        }
      }
    });
  } else {
...
var queryAthleteActivities = function queryAthleteActivities(_ref7) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: AthleteActivities.AthleteActivities
        }
      }
    });
  } else {
...
var queryAthleteClubs = function queryAthleteClubs(_ref8) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: AthleteClubs.AthleteClubs
        }
      }
    });
  } else {
...
var queryAthleteRoute = function queryAthleteRoute(_ref9) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: AthleteRoute.AthleteRoute
        }
      }
    });
  } else {
...
var queryAthleteStats = function queryAthleteStats(_ref10) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: AthleteStats.AthleteStats
        }
      }
    });
  } else {
...
var queryAuthenticatedAthlete = function queryAuthenticatedAthlete(_ref11) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: AuthenticatedAthlete.AuthenticatedAthlete
        }
      }
    });
  } else {
...
var queryClubActivities = function queryClubActivities(_ref13) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: ClubActivities.ClubActivities
        }
      }
    });
  } else {
...
var queryClubAdministrators = function queryClubAdministrators(_ref14) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: ClubAdministrators.ClubAdministrators
        }
      }
    });
  } else {
...
var queryClubMembers = function queryClubMembers(_ref15) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: ClubMembers.ClubMembers
        }
      }
    });
  } else {
...
var queryRouteStream = function queryRouteStream(_ref18) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: RouteStream.RouteStream
        }
      }
    });
  } else {
...
var querySegmentEfforts = function querySegmentEfforts(_ref19) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: SegmentEfforts.SegmentEfforts
        }
      }
    });
  } else {
...
var querySegmentEffortsStream = function querySegmentEffortsStream(_ref20) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: SegmentEffortsStream.SegmentEffortsStream
        }
      }
    });
  } else {
...
var querySegmentsStreams = function querySegmentsStreams(_ref22) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: SegmentsStreams.SegmentsStreams
        }
      }
    });
  } else {
...
var queryStarredSegments = function queryStarredSegments(_ref23) {
  ...
  if (stage === "dev") {
    return Promise.resolve({
      data: {
        getDataObject: {
          content: StarredSegments.StarredSegments
        }
      }
    });
  } else {
...
exports.queryActivityComments = queryActivityComments;
exports.queryActivityKudoers = queryActivityKudoers;
exports.queryActivityLaps = queryActivityLaps;
exports.queryActivityStream = queryActivityStream;
exports.queryActivityZone = queryActivityZone;
exports.queryAthleteActivities = queryAthleteActivities;
exports.queryAthleteClubs = queryAthleteClubs;
exports.queryAthleteRoute = queryAthleteRoute;
exports.queryAthleteStats = queryAthleteStats;
exports.queryAuthenticatedAthlete = queryAuthenticatedAthlete;
exports.queryClub = queryClub;
exports.queryClubActivities = queryClubActivities;
exports.queryClubAdministrators = queryClubAdministrators;
exports.queryClubMembers = queryClubMembers;
exports.queryEquipment = queryEquipment;
exports.queryRoute = queryRoute;
exports.queryRouteStream = queryRouteStream;
exports.querySegmentEfforts = querySegmentEfforts;
exports.querySegmentEffortsStream = querySegmentEffortsStream;
exports.querySegments = querySegments;
exports.querySegmentsStreams = querySegmentsStreams;
exports.queryStarredSegments = queryStarredSegments;
exports.queryUpload = queryUpload;
exports.queryZones = queryZones;
